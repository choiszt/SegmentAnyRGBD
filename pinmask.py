...
class maskpinner:
	def __init__(self):
		with open('/mnt/lustre/jkyang/PSG4D/sailvos3d/downloads/annotation/train_24.json', 'r') as f:
			self.data= json.load(f)
		with open('/mnt/lustre/jkyang/PSG4D/sailvos3d/downloads/annotation//val_24.json', 'r') as f:
...
"trvram_5_con"]
    ...
    252, 252, 252, 253, 253, 253, 254, 254, 254, 255, 255, 255, 0, 0, 0
		...
		self.stuffdict={5024:[[0],'floor'],5025:[[0],'ground'],5026:[[0],'wall'],5027:[[0],'window'],5028:[[0],'stair'],5029:[[0],'fence'],5030:[[0],'grass']}
		self.font = ImageFont.truetype("/mnt/lustre/jkyang/PSG4D/liushuai_workdir/OpenSans-Bold.ttf",20)
		self.tickfont = ImageFont.truetype("/mnt/lustre/jkyang/PSG4D/liushuai_workdir/OpenSans-Bold.ttf",40)
